...
function init(){
	var url = location.href; //주소를 검색후 돌아올 url
	var confmKey = "devU01TX0FVVEgyMDIxMTEyNDEwMTQyNDExMTkzNDI="; //승인키
	var resultType = "4"; // 4 : 도로명+지번+상세보기(관련지번, 관할주민센터, 상세건물명)
	var inputYn= "<%=inputYn%>";
	if(inputYn != "Y"){
		//주소창 검색 실행전
